  ...
  _createClass(WiggleRenderer, [{
    ...
    value: function draw(t, dt) {
      ...
      game.world.forEachObject(function (id, obj) {
        if (obj instanceof _Wiggle.default) _this2.drawWiggle(obj);else if (obj instanceof _Bullet.default) _this2.drawCircle(obj.position.x, obj.position.y, .1);else if (obj instanceof _Food.default) _this2.drawFood(obj);
      });
      ctx.restore();
    }
  }, {
